...
<!-- BEGIN LOGO -->
      <div class="logo">
         <a href="{{ URL::asset('') }}students/dashboard">
      ...
      <div class="content">
            ...
            <form id="form-login" action="{{ url('students/login') }}" method="POST" role="form">
                {{ csrf_field() }}
               ...
               <!--  <div class="alert alert-danger">
                ...
                <!-- <div class="create-account">
                    <p>
                        <a href="{{ url('students/register') }}" id="register-btn" class="uppercase">Tạo Tài Khoản</a>
                    </p>
                </div> -->
            </form>
            </div>
