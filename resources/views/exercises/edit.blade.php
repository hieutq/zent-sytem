...
<div class="portlet light bordered" id="form_wizard_1">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus-circle" aria-hidden="true"></i> CẬP NHẬT BÀI TẬP  </div>
        {{-- <div class="actions">
                            ...
                            <h3 class="block">Nội dung</h3>
                                ...
                                <div class="form-body col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1">
                                    ...
                                    <div id = "form-level-id" class="form-group form-md-line-input form-md-floating-label">
                                      <select  id = "level_id" class="form-control" name="level_id">
                                          @if ($levels) @foreach($levels as $level)
                                            <option value="{{$level->id}}" @if($level->id == $exercise->level_id) selected @endif>{{$level->name}}</option>
                                          @endforeach @endif
                                      </select>
                                 ...
                                 <div id = "form-content" class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" id="content" name="content" placeholder="Nội Dung">{{$exercise->content}}</textarea>
                            ...
                            <div class="form-actions text-center">
                              {{-- <div class="row"> --}}
                                  <div class="col-xs-12 col-sm-12">
                                      ...
                                      <a href="javascript:;" onclick="funUpdateExercise({{$exercise_id}});" class="btn btn-outline green button-next  btn-circle"> Cập nhật
  ...
  <script>
    ...
    function funUpdateExercise(id) {
      ...
      $.ajaxSetup({
        ...
        $.ajax({
              type: "PUT",
              url: "{{URL::asset('coursewares/exercises')}}/" + id,
              data: {
