...
<div class="dashboard-stat blue">
    ...
    <div class="details">
        <div class="number">
            <span data-counter="counterup" data-value="{{ $Feedback }}">0</span> <i class="fa fa-comments" aria-hidden="true"></i>
        </div>
...
<div class="dashboard-stat red">
    ...
    <div class="details">
        <div class="number">
            <span data-counter="counterup" data-value="{{$Student}}">0</span> <span class="icon-user"></span></div>
        <div class="desc"> Student </div>
    </div>
    <a class="more" href="{{route('student.listStudent')}}"> View more
        <i class="m-icon-swapright m-icon-white"></i>
    </a>
</div>
</div>
...
<div class="dashboard-stat green">
    ...
    <div class="details">
        <div class="number">
            <span data-counter="counterup" data-value="{{$ClassRoom}}">0</span> <i class="fa fa-th" aria-hidden="true"></i>
        </div>
        <div class="desc"> ClassRoom </div>
    </div>
    <a class="more" href="{{route('classroom.index')}}"> View more
        <i class="m-icon-swapright m-icon-white"></i>
    </a>
</div>
</div>
...
<div class="dashboard-stat purple">
    ...
    <div class="details">
        <div class="number">
            <span data-counter="counterup" data-value="{{$Course}}">0</span><i class="fa fa-graduation-cap" aria-hidden="true"></i></div>
        <div class="desc"> Course </div>
    </div>
    <a class="more" href="{{route('courses.index')}}"> View more
        <i class="m-icon-swapright m-icon-white"></i>
    </a>
</div>
</div>
