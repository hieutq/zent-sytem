                    ...
                    @if (Auth::guard('web')->check() && !Request::is('students*'))
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                          ...
                          <li class="nav-item {{ Request::is('classroom*') ? 'active open' : '' }}  ">
                                <a href="{{route('classroom.index')}}" class="nav-link nav-toggle">
                            ...
                            {{-- <li class="nav-item {{ Request::is('students') ? 'active open' : '' }}  ">
                                <a href="{{ route('student.listStudent') }}" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item {{ Request::is('student-cares') ? 'active open' : '' }}  ">
                                <a href="{{ route('studentCares')}}" class="nav-link nav-toggle">
                            ...
                            <!-- START HOC LIEU -->
                            <li class="nav-item  {{ Request::is('coursewares*') ? 'active open' : '' }}">
                                <a href="{{ route('coursewares.index')}}" class="nav-link nav-toggle">
                                    <i class="fa fa-file-text" aria-hidden="true"></i>
                                    <span class="title">Học Liệu</span>
                                </a>
                            </li> 
                        </ul>
                    @else
