        ...
        <div class="col-md-12">
          <ul class="list-inline">
           <li class="btn-group col-md-6 pull-left">
              <button id="myBtn" class="btn green  btn-outline" data-toggle="dropdown">Thêm
      ...
      @foreach($users as $db)
          <tr align="center" id="userRow{{$db->id}}">
              ...
              <td>
                <ul class="list-inline">
                    <li>
                        <a href="#"><i class="fa fa-info btn-detail btn-info style-css" data-id="{{$db->id}}" aria-hidden="true" title="Xem Chi tiết User"></i></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-pencil-square-o btn-warning btn-edit style-css " data-id="{{$db->id}}" aria-hidden="true" title="Sửa Thông Tin User"></i></a>
                    </li>
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <li>
                        <a href="#"><i class="fa fa-trash-o btn-danger btn-del  style-css action-{{$db->id}}" data-id="{{$db->id}}" aria-hidden="true" title="Xóa User"></i> </a>
                    </li>
                </ul> 
              </td> 
          </tr>
