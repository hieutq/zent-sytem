...
<div class="portlet light bordered">
    <div class="portlet-body">
    	<div class="row">
    		...
    		<div class="col-md-4"><h4 style="text-align: center;">Gọi Điện Cho Học Viên</h4></div>
            <div class="col-md-4"></div>
    		<form action="" name="frmCallStudentCare" id="frmCallStudentCare" class="form-horizontal" role="form">
    			<div class="row col-md-12">
                    ...
                    <div class="form-group form-md-line-input">
                    	...
                    	<div class="col-sm-9">
                           ...
                           <input class="style-formEdit form-control " id="care_type"  name="care_type" value="3" type="hidden"/>
                           <input class="style-formEdit form-control " id="reviver_address"  name="reviver_address" value="2" type="hidden"/>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                        <div class="col-sm-2"></div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-sm-9">
                           <select name="status" id="status" class="form-control">
                               <option value="2">Đã nghe máy</option>
                               <option value="3">Không nge máy</option>
                           </select>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
    ...
    <div class="portlet-body">
        <div class="table-toolbar">
            <div class="row">
                ...
                <h4>Danh Sách Số Lần Chăm Sóc Học Viên</h4>
                </div>
                    ...
                    <tr align="center" id="StudentstudenCare{{$db->id}}">
                        ...
                        <td>@if ($db->status==1) 
                            ...
                            @elseif ($db->status==2)
                                Đã nge máy
                            @elseif($db->status==3)
                                <span style="color: red">Không nge máy (cần gọi lại)</span>
                            @endif
                        </td>
                        <td>
...
<script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
  <script>
	...
	<script src="{{url('js/call_student.js')}}" type="text/javascript"></script>
