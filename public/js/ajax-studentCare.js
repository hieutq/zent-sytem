$(function(){
	// ======================validate formCreate=====================
		// ===============careType=======================
		// $('#abcd').blur(function() {
		// 	var careType = $('#abcd').val();
		// 	if (careType=="") {
		// 		$('.errorCare').show();
		// 		$('.errorCare').html('Chọn kiểu quan tâm');
		// 	}
		// 	else {
		//         $('.errorCare').hide();
		//     }
		// });
		// // ===============reviverAddress=======================
		// $('#reviverAddress').blur(function() {
		// 	var reviverAddress = $('#reviverAddress').val();
		// 	if (reviverAddress=="") {
		// 		$('.errorReviverAddress').show();
		// 		$('.errorReviverAddress').html('Chọn hình thức quan tâm');
		// 	}
		// 	else {
		//         $('.errorReviverAddress').hide();
		//     }
		// });
		// // ===============Content=======================
		...
		// 	if (content=="") {
		// 		$('.errorContent').show();
		// 		$('.errorContent').html('Nội dung không được để trống');
		// 	}
		// 	else {
		//         $('.errorContent').hide();
		//     }
		...
		// });
		// // ===============reviverAddress=======================
		// $('#reviver_address').blur(function() {
		// 	var reviver_address = $('#reviver_address').val();
		// 	if (reviver_address=="") {
		// 		$('.errorReviverAddress').show();
		// 		$('.errorReviverAddress').html('Chọn hình thức quan tâm');
		// 	}
